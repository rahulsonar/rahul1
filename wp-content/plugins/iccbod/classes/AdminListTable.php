<?php
/**
 * Administration API: AdminListTable class
 *
 * @package WordPress
...
class AdminListTable {
    ...
    public function ajax_user_can() {
        die('function AdminListTable::ajax_user_can() must be over-ridden in a sub-class.');
    }

    /**
     * Prepares the list of items for displaying.
     * @uses AdminListTable::set_pagination_args()
     *
     * @since 3.1.0
     * @access public
     * @abstract
    ...
    public function prepare_items() {
        die('function AdminListTable::prepare_items() must be over-ridden in a sub-class.');
    }
    ...
    public function get_columns() {
        die('function AdminListTable::get_columns() must be over-ridden in a sub-class.');
    }
    ...
    /**
     * Public wrapper for AdminListTable::get_default_primary_column_name().
     *
     * @since 4.4.0
     * @access public
     *
    ...
    protected function get_primary_column_name() {
        ...
        if (!isset($columns[$default])) {
            $default = AdminListTable::get_default_primary_column_name();
        }
    ...
    /**
     * Get a list of CSS classes for the AdminListTable table tag.
     *
     * @since 3.1.0
     * @access protected
     *
